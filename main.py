...
class GenerateVideoRequest(BaseModel):
    ...
    prompt_language: Optional[str] = "pt"
    # Pet video fields
    ...
    payload = {
        ...
        "parameters": {
            ...
            "negativePrompt": (
                ...
                "product deformation, bent product, melting product, warped label, "
                "illegible text, blurry packaging, distorted logo, "
                "product morphing, product resizing, product shape change, "
